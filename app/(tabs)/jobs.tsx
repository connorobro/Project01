...
const s = StyleSheet.create({
  ...
  input: {
    height: 42, borderRadius: 12, backgroundColor: "#ffffff",
    borderWidth: 1, borderColor: "#d1fae5", paddingHorizontal: 12,
    justifyContent: "center", marginTop: 10, marginBottom: 12,
  },
  muted: { color: "#6b7280" },
  ...
  pagerRow: { marginTop: "auto", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 12 },
  pagerBtn: { backgroundColor: "#0ea5a4", paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10 },
